    ...
    <div class="page-container">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Directorio de artistas inscriptos</p>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="empty-state">
            ...
            <h3 class="empty-title">Directorio de artistas</h3>
            <p class="empty-desc">Aca se mostraran todos los artistas inscriptos con sus fichas y documentacion.</p>
          </div>
        </div>
      </div>
    </div>
...
export class ArtistasListPageComponent {}
